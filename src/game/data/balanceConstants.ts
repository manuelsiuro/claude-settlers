...
export let WILD_ANIMAL_SCALE_RABBIT = 0.25;
export let WILD_ANIMAL_SCALE_MOUNTAIN_GOAT = 0.20;
...
export function resetBalanceDefaults(): void {
  ...
  WILD_ANIMAL_SCALE_RABBIT = 0.25;
  WILD_ANIMAL_SCALE_MOUNTAIN_GOAT = 0.20;
