...
/** Returns an inline PNG thumbnail for a resource type */
export function resourceIcon(type: string, size: number = 16): string {
  return `<img src="/thumbnails/resources/${type}.png" width="${size}" height="${size}" alt="" style="display:inline-block;vertical-align:middle;flex-shrink:0;object-fit:contain">`;
}

/** Returns an inline PNG thumbnail for a building type */
export function buildingIcon(type: string, size: number = 16): string {
  return `<img src="/thumbnails/buildings/${type}.png" width="${size}" height="${size}" alt="" style="display:inline-block;vertical-align:middle;flex-shrink:0;object-fit:contain">`;
}

/** Returns an inline PNG thumbnail for a unit type */
export function unitIcon(type: string, size: number = 16): string {
  return `<img src="/thumbnails/units/${type}.png" width="${size}" height="${size}" alt="" style="display:inline-block;vertical-align:middle;flex-shrink:0;object-fit:contain">`;
}
